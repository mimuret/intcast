...
func TestUInt(t *testing.T) {
	...
	testcases := []testcase{
		...
		// MaxUint8
		//{"math.MaxUint:int8", true, int8(math.MaxUint)},
		//{"math.MaxUint:int16", true, int16(math.MaxUint)},
		//{"math.MaxUint:int32", true, int32(math.MaxUint)},
		//{"math.MaxUint:int64", true, int64(math.MaxUint)},
		//{"math.MaxUint:int", true, int(math.MaxUint)},
		// MaxUint8+1
		//{"math.MaxUint+1:int8", false, int8(math.MaxUint) + 1},
		//{"math.MaxUint+1:int16", false, int16(math.MaxUint + 1)},
		//{"math.MaxUint+1:int32", false, int32(math.MaxUint) + 1},
		//{"math.MaxUint+1:int64", false, int64(math.MaxUint) + 1},
		//{"math.MaxUint+1:int", false, int(math.MaxUint) + 1},
		// MaxUint*
		{"maxU8:uint8", true, uint8(math.MaxUint8)},
		{"maxU16:uint16", true, uint16(math.MaxUint16)},
		{"maxU32:uint32", true, uint32(math.MaxUint32)},
		{"maxU64:uint64", true, uint64(math.MaxUint)},
		...
		// MaxInt8
		//{"math.MaxUint:uint8", true, uint8(math.MaxUint)},
		//{"math.MaxUint:uint16", true, uint16(math.MaxUint)},
		//{"math.MaxUint:uint32", true, uint32(math.MaxUint)},
		{"math.MaxUint:uint64", true, uint64(math.MaxUint)},

		// MaxInt8+1
		//{"math.MaxUint+1:uint8", false, uint8(math.MaxUint + 1)},
		//{"math.MaxUint+1:uint16", false, uint16(math.MaxUint + 1)},
		//{"math.MaxUint+1:uint32", false, uint32(math.MaxUint + 1)},
		//{"math.MaxUint+1:uint64", false, uint64(math.MaxUint + 1)},
	...
	if !is64 {
		testcases = append(testcases,
			testcase{"math.MaxUint:uint", true, uint(math.MaxUint)},
		)
	}
	for _, tc := range testcases {
		_, err := cast.GetUInt(tc.Value)
		if err != nil && tc.OK {
