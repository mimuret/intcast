...
func TestUInt8(t *testing.T) {
	testcases := []testcase{
		...
		// MaxUint8
		//{"math.MaxUint8:int8", true, int8(math.MaxUint8)},
		{"math.MaxUint8:int16", true, int16(math.MaxUint8)},
		{"math.MaxUint8:int32", true, int32(math.MaxUint8)},
		{"math.MaxUint8:int64", true, int64(math.MaxUint8)},
		{"math.MaxUint8:int", true, int(math.MaxUint8)},
		// MaxUint8+1
		//{"math.MaxUint8+1:int8", false, int8(math.MaxUint8) + 1},
		{"math.MaxUint8+1:int16", false, int16(math.MaxUint8 + 1)},
		{"math.MaxUint8+1:int32", false, int32(math.MaxUint8) + 1},
		{"math.MaxUint8+1:int64", false, int64(math.MaxUint8) + 1},
		{"math.MaxUint8+1:int", false, int(math.MaxUint8) + 1},
		// MaxUint*
		...
		// MaxInt8
		{"math.MaxUint8:uint8", true, uint8(math.MaxUint8)},
		{"math.MaxUint8:uint16", true, uint16(math.MaxUint8)},
		{"math.MaxUint8:uint32", true, uint32(math.MaxUint8)},
		{"math.MaxUint8:uint64", true, uint64(math.MaxUint8)},
		{"math.MaxUint8:uint", true, uint(math.MaxUint8)},
		// MaxInt8+1
		//{"math.MaxUint8+1:uint8", false, uint8(math.MaxUint8 + 1)},
		{"math.MaxUint8+1:uint16", false, uint16(math.MaxUint8 + 1)},
		{"math.MaxUint8+1:uint32", false, uint32(math.MaxUint8 + 1)},
		{"math.MaxUint8+1:uint64", false, uint64(math.MaxUint8 + 1)},
		{"math.MaxUint8+1:uint", false, uint(math.MaxUint8 + 1)},
		// invalid
		{"invalid", false, "1"},
	}

	for _, tc := range testcases {
		_, err := cast.GetUInt8(tc.Value)
		if err != nil && tc.OK {
